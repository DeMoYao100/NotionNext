...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'moyaoxue', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'rev/pwn@天枢', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'blog.moyaoxue.de', // 网站地址
